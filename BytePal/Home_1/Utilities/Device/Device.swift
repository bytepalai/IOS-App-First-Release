    ...
    func setDeviceGroup() {
        switch UIDevice().type {
            ...
            case .iPhone6SPlus:
                ...
                self.deviceSizeGroup = "iPhone6SPlusDeviceGroup"
            case .iPhone6S:
                print("375 x 667: .iPhone6S")
                self.deviceSizeGroup = "iPhone6SDeviceGroup"
            default:
                print("default")
        }
    }
